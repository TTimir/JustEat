<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="JustEat.Admin.Category" %>
                                                    ...
                                                    <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemCommand" OnItemDataBound="rCategory_ItemDataBound">
                                                            ...
                                                            <table class="table data-table-export table-hover nowrap">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>IsActive</th>
                                                                        <th>CreatedDate</th>
                                                                        <th class="datatable-nosort">Actions's</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img src="<%# Connection.Utils.GetImageUrl( Eval("ImageUrl")) %>" alt="Overview" width="40" />
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server" CssClass="badge badge-primary"
                                                                        ...
                                                                        CommandName="edit" CausesValidation="false"><i class="ti-pencil"></i></asp:LinkButton>
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge badge-danger"
                                                                        CommandArgument='<%# Eval("CategoryId") %>'
                                                                        CommandName="delete" OnClientClick="return confirm('Do you want to delete this category?')" CausesValidation="false"><i class="ti-trash"></i></asp:LinkButton>
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
