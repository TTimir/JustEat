<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="JustEat.Admin.OrderStatus" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server" CssClass="badge badge-primary"
                                                                        CommandArgument='<%# Eval("OrderDetailsId") %>'
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <asp:RequiredFieldValidator ID="rfvOrderStatus" runat="server" ForeColor="Red"
                                                                ControlToValidate="ddlOrderStatus" ErrorMessage="Please Select Order Status!" SetFocusOnError="true" Display="Dynamic" InitialValue="0"></asp:RequiredFieldValidator>
                                                            <asp:DropDownList ID="ddlOrderStatus" runat="server" CssClass="form-control">
                                                                ...
                                                                <asp:ListItem Value="Prepared">Prepared</asp:ListItem>
                                                            </asp:DropDownList>
