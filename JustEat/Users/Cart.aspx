...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        /* Hide the spinners for Chrome, Safari, Edge, Opera */
            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <img src="<%# Connection.Utils.GetImageUrl(Eval("ImageUrl")) %>" alt="" width="60" />
                        </td>
                        ...
                        <td>
                            <div class="product__details__option">
                                <div class="quantity">
                                    <div class="pro-qty">
                                        <asp:TextBox ID="txtQuantity" runat="server" TextMode="Number" Text='<%# Eval("Quantity") %>' CssClass="no-spinners"></asp:TextBox>
                        ...
                        <td>
                            <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove"
                                CommandArgument='<%# Eval("ProductId") %>' OnClientClick="return confirm('Don\'t like this food? Think again..');">
