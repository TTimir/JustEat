<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="JustEat.Users.Contact1" %>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        <div>
                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="What's Your Name?"></asp:TextBox>
                        ...
                        <div>
                            <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" placeholder="Contact Email" TextMode="Email"></asp:TextBox>
                        ...
                        <div>
                            <asp:TextBox ID="txtMessage" runat="server" CssClass="form-control" placeholder="How Can We Help? Enter Your Query/Feedback" TextMode="MultiLine"
                                Rows="5"></asp:TextBox>
